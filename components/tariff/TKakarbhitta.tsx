...
export default function TKakarbhitta() {
  const freightEntryData = [
    ...
    { sn: "2", activity: "Rickshaw / Hand Trolley per entry per trip", vehicle: <span className="pl-24 block">129.69</span>, teu: "", feu: "" },
    { sn: "3", activity: "Light Vehicles/Bullock Cart with capacity up to 5 Ton per entry", vehicle: <span className="pl-24 block">38.94</span>, teu: "", feu: "" },

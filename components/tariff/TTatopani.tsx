// components/tariff/ContentTatopani.tsx
"use client";
...
export default function TTatopani() {
  const freightEntryData = [
    ...
    { sn: "2", activity: "Light Vehicles/Bullock Cart with capacity up to 5 Ton per entry", vehicle: "129.69", teu: "", feu: "" },
    { sn: "3", activity: "Rickshaw / Hand Trolley per entry per trip", vehicle: "38.94", teu: "", feu: "" },
  ...
  const cargoHandlingData = [
    // Keep all values under the correct columns: "Vehicle" | "TEU" | "FEU"
